...
### Mechanizm
Zwiększenie udziału Fz z tyłu przez ustawienie kątów / overlap / gap wieloelementowego RW w stronę optimum 2D (Staniszewski 2023) **na pakiecie** 017; montaż możliwie wysoko (Jackson: uniknąć disturbed flow za HR / roll hoop). Opcjonalna pod-hipoteza CAD: **4 elementy** zamiast 3 (więcej powierzchni/slotów w envelope T8) — **bez** liczb ΔCz w ekstraktach.
...
- **Yaw:** FW/RW „płaskie” vs δ względem UT (Staniszewski 2024) — H1 mniej yaw-wrażliwe niż H2, ale coupling body nadal.
...
- 4-el.: nie mieści się w T8 / T 8.3 bez utraty \|Cz\| vs 3-el. → porzuć 4-el., zostań przy 3-el. + kąacja kątów.
