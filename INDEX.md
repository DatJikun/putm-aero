...
| [sources/checklist-h1-fluent-rw.md](sources/checklist-h1-fluent-rw.md) | Checklist H1 pod Fluent: kąty→overlap→gap + kill stall (OF 2D stop) |
...
| [sources/research-h2-strakes-yaw-rideheight.md](sources/research-h2-strakes-yaw-rideheight.md) | H2 pogłębienie: strakes + yaw + ride height (bez TARGETS) |
...
| [sources/research-rw-3vs4-elements-teams.md](sources/research-rw-3vs4-elements-teams.md) | 3 vs 4 el. RW: papery/top teamy; bez head-to-head ΔCl na kartę |
